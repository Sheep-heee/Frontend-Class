...
const showPosition = (position) => {
  ...
  const positions = [
    {
      title: "올리브영 강남우성점",
      latlng: new kakao.maps.LatLng(37.4918902, 127.030925),
    ...
    <div class="wrap">
      <div class="info">
        ...
        <div class="body"> 
          ...
          <div class="desc">
            <div class="ellipsis">${positions[i].address}
            </div>
            <div class="jibun ellipsis">${positions[i].info}
            </div>
            <div><a href="https://www.oliveyoung.co.kr/store" target="_blank" class="link">쇼핑몰 바로가기</a>
            </div>
          </div>
        </div>
      </div>
